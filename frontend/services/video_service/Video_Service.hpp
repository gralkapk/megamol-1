...
class megamol::core::MegaMolGraph;
...
class Video_Service final : public AbstractFrontendService {
public:
...
private:
    ...
    std::unique_ptr<VPL_Setup> setup_;

    megamol::core::MegaMolGraph* megamolgraph_ptr = nullptr;
};
