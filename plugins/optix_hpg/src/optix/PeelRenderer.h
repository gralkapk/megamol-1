...
class PeelRenderer : public AbstractRenderer<device::FrameState_peel> {
public:
    ...
    static const char* Description(void) {
        return "PeelRenderer using OptiX framework";
    }
...
private:
    ...
    CUdeviceptr ray_buffer_ptr = 0;

    CUdeviceptr treelet_requests_ptr = 0;

    glm::ivec2* hp_treelet_requests_ptr_ = 0;
};
} // namespace megamol::optix_hpg
