 ...
 */
#ifndef hpg_H_INCLUDED
#define hpg_H_INCLUDED
...
#ifdef hpg_EXPORTS
#define hpg_API __declspec(dllexport)
#else
#define hpg_API __declspec(dllimport)
#endif
#else /* _WIN32 */
#define hpg_API
#endif /* _WIN32 */
 ...
 * @return 200 -- (ver.: 2.00)
 */
hpg_API int mmplgPluginAPIVersion(void);
 ...
 */
hpg_API void mmplgReleasePluginCompatibilityInfo(
 ...
 */
hpg_API void mmplgReleasePluginInstance(
